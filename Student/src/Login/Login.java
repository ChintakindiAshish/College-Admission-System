...
public class Login extends JFrame {
	...
	public Login() throws UnknownHostException, IOException {
		...
		lblAdminPortal = new JLabel("Student Portal");
		lblAdminPortal.setBounds(553, 134, 174, 26);
		...
		btnNewButton_1.setBounds(87, 310, 171, 15);
		...
		btnNewUser.setBackground(new Color(0, 0, 170));
		...
		btnNewUser.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnNewUser.setForeground(Color.yellow);
			}
		});
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					try {
						StudFrame frame = new StudFrame(thisframe,input,output);
